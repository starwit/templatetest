 ...
 */
public class UserControllerAcceptanceTest extends AbstractControllerAcceptanceTest<UserEntity> {


    final static Logger LOG = LoggerFactory.getLogger(UserControllerAcceptanceTest.class);
    private static final String data = "testdata/user/";
    private static final String restpath = "/api/users/";

    private JacksonTester<UserEntity> jsonTester;
    ...
    @Override
    public JacksonTester<UserEntity> getJsonTester() {
        return jsonTester;
    }
    ...
    public void canCreate() throws Exception {
        // given
//        UserEntity entity = readFromFile(data + "User.json");
...
//        UserEntity entityresult = mapper.readValue(response.getContentAsString(), UserEntity.class);
//        assertThat(entityresult.getBranch()).isEqualTo("v2");
    ...
    public void isValidated() throws Exception {
        // given
//        UserEntity entity = readFromFile(data + "User-wrong.json");
...
//        UserEntity entity = readFromFile(data + "User.json");
//        MockHttpServletResponse response = create(entity);
//        UserEntity entity2 = mapper.readValue(response.getContentAsString(), UserEntity.class);
